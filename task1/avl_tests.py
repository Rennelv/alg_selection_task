...
def test_insert():
    tree = AVLTree()
    values = [10, 20, 30, 40, 50, 25, 5, 5, 5, 15, 35, 45, 55, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 60000, 7000]
    for v in values:
        tree.insert(v)
...
def test_split():
    tree = AVLTree()
    values = [10, 20, 30, 40, 50, 25, 25, 25, 5, 15, 35, 45, 55, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 60000, 7000]
    for v in values:
        tree.insert(v)
...
def test_merge():
    tree1 = AVLTree()
    tree2 = AVLTree()
    values1 = [10, 20, 30, 40, 50, 25, 5, 15, 35, 45, 55, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 60000, 7000]
...
def test_max():
    tree = AVLTree()
    values = [10, 20, 30, 40, 50, 25, 5, 15, 35, 45, 55, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 60000, 7000]
    for v in values:
        tree.insert(v)
